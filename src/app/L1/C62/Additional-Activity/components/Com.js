  ...
  steps: [
    {
      ...
      images: [
        ...
        { src: s3, alt: "Product idea 3", label: "Slime Jar" },
        { src: s4, alt: "Product idea 4", label: "Keychain" },
        { src: s5, alt: "Product idea 5", label: "Rubber Band Bracelet" },
        { src: s6, alt: "Product idea 6", label: "Painted Rock" }
      ]
    },
    {
      id: 1,
