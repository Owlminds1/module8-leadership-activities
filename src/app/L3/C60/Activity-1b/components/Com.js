...
export default function Com() {
  ...
  const options = [
    { price: "$7.00", feedback: "He will make a loss." },
    { price: "$8.00", feedback: "He will make no profit." },
    { price: "$9.00", feedback: "He will make a small profit." },
    { price: "$11.00", feedback: "He will make a bigger profit." }
  ];
